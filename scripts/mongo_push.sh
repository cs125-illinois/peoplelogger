...
mongoimport --drop --uri="$REMOTE" -c discourseUsers -o fixtures/pushDiscourseUsers.json
mongoimport --drop --uri="$REMOTE" -c discourseUserChanges -o fixtures/pushDiscourseUserChanges.json
